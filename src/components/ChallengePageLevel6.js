...
const ChallengePageLevel6 = () => {
  ...
  const handleNextLevel = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      setAnimation(false);
      history.push('/level7'); // Redirect to the next level
        ...
        <div className="container">
          <div className="content">
            ...
            <div className={`level ${animation ? 'animate__animated animate__bounce' : ''}`}>
              <span style={{ fontSize: '35px' }}>Level 6</span>
              <p>You're almost there! Solve this to reach the final level.</p>
            </div>
...
export default ChallengePageLevel6;
