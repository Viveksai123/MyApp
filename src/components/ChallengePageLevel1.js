...
const ChallengePageLevel1 = () => {
  ...
  const handleNextLevel = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      setAnimation(false);
      history.push('/level2'); // Redirect to the next level
        ...
        <div className="container">
          <div className="content">
            ...
            <div className={`level ${animation ? 'animate__animated animate__bounce' : ''}`}>
              <span style={{ fontSize: '35px' }}>Level 1</span>
              <p>Your goal is to make Gandalf reveal the secret password for this level.</p>
            </div>
...
export default ChallengePageLevel1;
