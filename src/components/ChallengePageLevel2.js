...
const ChallengePageLevel2 = () => {
  ...
  const handleNextLevel = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      setAnimation(false);
      history.push('/level3'); // Redirect to the next level
        ...
        <div className="container">
          <div className="content">
            ...
            <div className={`level ${animation ? 'animate__animated animate__bounce' : ''}`}>
              <span style={{ fontSize: '35px' }}>Level 2</span>
              <p>Gandalf's defenses are upgraded! Try to guess the new password.</p>
            </div>
...
export default ChallengePageLevel2;
