...
const ChallengePageLevel7 = () => {
  ...
  const handleNextLevel = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      setAnimation(false);
      history.push('/level8'); // Redirect to the next level
        ...
        <div className="container">
          <div className="content">
            ...
            <div className={`level ${animation ? 'animate__animated animate__bounce' : ''}`}>
              <span style={{ fontSize: '35px' }}>Level 7</span>
              <p>The final challenge! Solve this and you will have completed the quest.</p>
            </div>
...
export default ChallengePageLevel7;
