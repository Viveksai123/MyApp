...
const ChallengePageLevel4 = () => {
  ...
  const handleNextLevel = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      setAnimation(false);
      history.push('/level5'); // Redirect to the next level
        ...
        <div className="container">
          <div className="content">
            ...
            <div className={`level ${animation ? 'animate__animated animate__bounce' : ''}`}>
              <span style={{ fontSize: '35px' }}>Level 4</span>
              <p>Another challenge awaits! Solve it to move forward.</p>
            </div>
...
export default ChallengePageLevel4;
