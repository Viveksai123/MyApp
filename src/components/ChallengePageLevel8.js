...
const ChallengePageLevel8 = () => {
  ...
  const handleFinish = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      setAnimation(false);
      history.push('/leaderboard'); // Redirect to the leaderboard after finishing all levels
        ...
        <div className="container">
          <div className="content">
            ...
            <div className={`level ${animation ? 'animate__animated animate__bounce' : ''}`}>
              <span style={{ fontSize: '35px' }}>Level 8</span>
              <p>Congratulations! You've reached the final level. Complete this challenge to see the results.</p>
            </div>
            ...
            <button className={animation ? 'animate__animated animate__rubberBand' : ''} onClick={handleFinish}>Finish</button>
            {loading && (
...
export default ChallengePageLevel8;
